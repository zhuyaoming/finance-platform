package com.yxyc.auth.server.runner;

import com.yxyc.auth.common.util.jwt.RsaKeyHelper;
...
/**
* @description  CommandLineRunner 服务启动优先启动 相当于Spring的ApplicationListener
* @author Yeoman
* @create 2018-03-28 16:22
**/
@Configuration
public class AuthServerRunner implements CommandLineRunner {
    @Autowired
    private RedisTemplate<String, String> redisTemplate;
    private static final String REDIS_USER_PRI_KEY = "FP:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "FP:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "FP:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "FP:AUTH:CLIENT:PUB";
